-- 058: Improve review clarity
--   - Add task evaluation comment tone rules (no congratulations for missed tasks)
--   - Add caveat that {interest_profile} is ALL-TIME data, not weekly
--   - Add structured learningSummaryData JSON schema
--   - Instruct qualitative (not numeric) time evaluation comments
--   - Enforce strict get_notes date filtering
