...
export let aiReviewReports: AIReviewReport[] = [
  {
    ...
    taskEvaluations: [
      { taskName: 'ICA試験勉強', status: 'good', comment: 'サブタスク1/3完了。Traffic Managementを中心に順調に進行中。' },
      { taskName: 'フロントエンド開発', status: 'partial', comment: 'サブタスク1/2完了。コンポーネント実装が進行中。' },
    ],
    timeEvaluations: [
      { goalName: 'Golden Kubestronaut', goalColor: '#0EA5E9', actualMinutes: 18 * 60, targetMinutes: 21 * 60, comment: '目標を概ね達成。良いペース。' },
      { goalName: 'OSS活動', goalColor: '#10B981', actualMinutes: 10 * 60, targetMinutes: 12 * 60, comment: '目標を概ね達成。良いペース。' },
      { goalName: 'アウトプット', goalColor: '#F59E0B', actualMinutes: 4 * 60, targetMinutes: 5 * 60, comment: '目標の87%。改善の余地あり。' },
    ],
    learningSummary:
      '今週は合計32時間の学習を実施。ICA試験勉強、フロントエンド開発に取り組んだ。Golden Kubestronautを中心に学習を進め、Traffic Managementの理解が深まった。',
    summary:
      '全体として計画の91%を達成。Golden Kubestronautの学習が順調に進む一方、アウトプット時間の確保が課題。',
    goodPoints: [
      '総学習時間32時間を達成',
      '12件のタスクを完了',
      'Golden Kubestronautに18時間を確保',
    ],
    improvementPoints: [
      '計画35hに対し実績32h（達成率91%）',
      'アウトプット目標の時間確保が課題',
