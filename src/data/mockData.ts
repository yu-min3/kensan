...
// 今日の時間記録（部分的な実績）
export const mockTodayTimeEntries: TimeEntry[] = [
  {
    id: 'te-today-1',
    date: today,
    startTime: '09:00',
...
// 未設定のユーザー設定
export const mockUnconfiguredSettings: UserSettings = {
  timezone: 'Asia/Tokyo',
  theme: 'system',
  isConfigured: false,
  userName: 'Guest',
...
// AI振り返りレポート
export const mockAIReviewReports: AIReviewReport[] = [
  {
    id: 'ai1',
...
// 日別学習時間データ（グラフ用）
export const mockDailyStudyHours = [
...
// 明日のタイムブロック（計画）
export const mockTomorrowTimeBlocks: TimeBlock[] = [
  {
    id: 'tb-tm1',
    date: tomorrow,
    startTime: '09:00',
